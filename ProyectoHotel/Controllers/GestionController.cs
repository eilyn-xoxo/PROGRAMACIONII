...
namespace ProyectoHotel.Controllers
{
    public class GestionController : Controller
    {
        ...
        [HttpGet]
        public JsonResult ListarHabitacion(int identrada)
        {
            List<Habitacion> oLista = new List<Habitacion>();
            oLista = HabitacionLogica.Instancia.Listar().Where(x => x.oEntrada.IdEntrada == (identrada == 0 ? x.oEntrada.IdEntrada : identrada) ).OrderBy(o => o.Numero).ToList();
