        ...
        public List<Recepcion> Listar()
        {
            ...
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                try
                {
                    ...
                    query.AppendLine("select r.IdRecepcion,p.Nombre,p.Apellido,p.Documento,p.Correo,h.IdHabitacion,h.Numero,h.Detalle,ps.Descripcion[DesEntrada],c.Descripcion[DesCategoria],");
                    ...
                    query.AppendLine("inner join ENTRADA ps on ps.IdEntrada = h.IdEntrada");
                        ...
                        while (dr.Read())
                        {
                            Lista.Add(new Recepcion()
                            {
                                ...
                                oHabitacion = new Habitacion() {
                                    ...
                                    oEntrada = new Entrada() { Descripcion = dr["DesEntrada"].ToString() },
